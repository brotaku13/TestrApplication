...
isUnique.testingDict = {("abcd",): True,
                        ...
                        ("AsdF 658",): True,
                        ("test",): False}
isUnique.hint1 = "*** Hint 1 ***\nHow can you iterate through a string? Keep in mind there are more ways to go through a string.\n"
isUnique.hint2 = "*** Hint 2 ***\nHow can you tell if a string has more than one of the same character?\n"
isUnique.hint3 = "*** Hint 3 ***\nTry using a nested loop to iterate through the string and compare each character to all the characters before it.\n"
isUnique.example = "\"abc\" is a unique string while \"aaa\" is not."
isUnique.answer = "answer test"
